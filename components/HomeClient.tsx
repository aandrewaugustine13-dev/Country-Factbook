...
export function HomeClient({ countries }: { countries: CountryItem[] }) {
  ...
  const [govQuery, setGovQuery] = useState('All Governments');
  ...
  const filtered = useMemo(() => {
    ...
    if (govQuery !== 'All Governments') {
      const qGov = govQuery.toLowerCase();
    ...
    return result;
  }, [countries, query, region, govQuery, landlocked, popRange]);
    ...
    <>
      <div className="controls">
        ...
        <div className="advanced-filters">
          ...
          <select className="filter-select" value={govQuery} onChange={(e) => setGovQuery(e.target.value)}>
